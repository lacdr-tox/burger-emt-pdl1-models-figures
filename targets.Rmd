...
remotes::install_cran(c("drc", "jpeg", "colorspace", "grid", "cowplot", "magick", "future", "future.callr", "targets", "tarchetypes", "scales", "parallel", "glue", "colorblindr", "patchwork", "fs", "magick", "rootSolve" 'tidyverse'))
...
source("R/functions.R")
source("R/common_plotstuff.R")
tar_option_set(packages = c("drc", "future", "future.callr", "cowplot", "magick", "jpeg", "grid",  "colorspace", "tarchetypes", "scales", "parallel", "glue", "magrittr", "colorblindr", "patchwork", "fs", "magick", "rootSolve", "tidyverse"))
library(tarchetypes)
library(future)
library(future.callr)
plan(callr)
tar_config_set(workers = 12)
