...
remotes::install_cran(c("drc", "colorspace", "grid", "cowplot", "magick", "targets", "tarchetypes", "scales", "glue", "colorblindr", "fs", "rootSolve", 'tidyverse'))
...
source("R/functions.R")
source("R/common_plotstuff.R")
tar_option_set(packages = c("drc", "cowplot", "magick", "grid",  "colorspace", "tarchetypes", "scales", "glue", "magrittr", "colorblindr", "fs", "rootSolve", "tidyverse"))
library(tarchetypes)
